...
const STATIC_NAV: CommandItem[] = [
  ...
  { id: 'nav-agents', label: 'Estúdio de Agentes IA', group: 'navegar', Icon: Bot, to: '/agents', keywords: 'studio agente persona prompt ia' },
  { id: 'nav-pix', label: 'Pix QR & Cobranças', group: 'navegar', Icon: CreditCard, to: '/pix', keywords: 'pagamento pix qr checkout venda' },
  { id: 'nav-voice', label: 'Voice Studio (Vozes IA)', group: 'navegar', Icon: Volume2, to: '/voice', keywords: 'audio voz clonada humanizada' },
  { id: 'nav-audio-lib', label: 'Biblioteca de Áudios', group: 'navegar', Icon: Library, to: '/audio-library', keywords: 'audios gravados mensagens' },
  { id: 'nav-coach', label: 'Acássia Copilot', group: 'navegar', Icon: Bot, to: '/coach', keywords: 'ia coach review copilot assistente' },
  { id: 'nav-scheduling', label: 'Agendamentos & Reuniões', group: 'navegar', Icon: CalendarDays, to: '/scheduling', keywords: 'agenda consultas horarios reunioes' },
  { id: 'nav-pipeline', label: 'Pipeline de Vendas (CRM)', group: 'navegar', Icon: FolderTree, to: '/pipeline', keywords: 'crm leads kanban vendas funil' },
  { id: 'nav-broadcast', label: 'Disparo em Massa (Broadcast)', group: 'navegar', Icon: MessageSquare, to: '/broadcast', keywords: 'disparo lista transmissao zap' },
  { id: 'nav-affiliate', label: 'Programa de Afiliados', group: 'navegar', Icon: CreditCard, to: '/affiliate', keywords: 'indicacao referral comissao' },
  { id: 'nav-funnel', label: 'Analytics — Funis de Conversão', group: 'navegar', Icon: Activity, to: '/analytics/funnel', keywords: 'metrics funnel conversion taxa' },
  { id: 'nav-recovery', label: 'Analytics — Recuperação de Vendas', group: 'navegar', Icon: Activity, to: '/analytics/recovery', keywords: 'recovery winback carrinho pix boleto' },
  { id: 'nav-runs', label: 'Logs de Execução', group: 'navegar', Icon: Activity, to: '/runs', keywords: 'logs run debug rastreamento' },
