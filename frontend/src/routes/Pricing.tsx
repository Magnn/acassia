...
const PLANS = [
  ...
  },
  {
    ...
    price: 149,
    period: '/mês',
    desc: 'Para quem vive de espiritualidade e quer escalar.',
    icon: Crown,
    gradient: 'from-accent-amethyst to-pink-500',
    border: 'border-accent-amethyst',
    features: [
      'Tudo do Essencial +',
      'Leads ilimitados',
      'Leitura Multi-Modal IA',
      'Gerador de Conteúdo Social',
      'Broadcast WhatsApp',
      'Comunidade com Oráculo IA',
      'Rituais + Diário + Sonhos',
  ...
  },
  {
    ...
    price: 399,
    period: '/mês',
    desc: 'Para clínicas, institutos e operações premium.',
    icon: Rocket,
    ...
    features: [
      ...
      'Trilhas de conteúdo ilimitadas',
      'White-label (sem marca Meu Mistério)',
