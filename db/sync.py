...
def sync_database():
    ...
    try:
        ...
        _add_column_if_missing(inspector, "social_webhook_receipts", "public_reply_sent", "BOOLEAN NOT NULL DEFAULT 0")
        _add_column_if_missing(inspector, "social_webhook_receipts", "private_reply_sent", "BOOLEAN NOT NULL DEFAULT 0")
        _add_column_if_missing(inspector, "social_webhook_receipts", "last_error", "VARCHAR(500)")
        _add_column_if_missing(inspector, "social_webhook_receipts", "payload_json", "JSON NOT NULL DEFAULT '{}'")
        _add_column_if_missing(inspector, "contact_imports", "payload_json", "JSON NOT NULL DEFAULT '{}'")
        _add_column_if_missing(inspector, "broadcast_recipients", "claimed_at", "TIMESTAMP")
